...
public class test6 {
    public static void main(String[] args) {
        ...
        var select_select = new SelectFilterProperty();
        select_select.filterValue = "Période de publication";
        select_select.filterBy = FilterBy.LABEL;
        select_select.elementType = FilterElementType.SELECT;
        select_select.nthChild = 1;
        
        var select = selectLib.selectElement(select_select);
